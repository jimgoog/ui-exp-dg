...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOS_KlutterKt")))
@interface SharedCodeIOS_KlutterKt : SharedCodeBase
+ (void)initializeView:(UIView *)view __attribute__((swift_name("initialize(view:)")));
